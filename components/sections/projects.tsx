...
const intro =
  "Building production AI agents and automations that turn ambiguous business workflows into reliable, adoptable systems. I work the full lifecycle: designing LLM-powered tools, shipping them in n8n, Python, and Claude or OpenAI APIs, and getting non-technical teams to actually use them.";
    ...
    >
      ...
      <div className="w-full max-w-3xl mt-10">
        ...
        <ul className="list-disc pl-6 space-y-3 text-white/90 leading-relaxed">
          <li>
            <span className="font-semibold">Building AI Agents:</span> Designing multi-agent LLM systems with LangChain, CrewAI, and Claude or OpenAI APIs for real production workloads.
          </li>
          <li>
          ...
          <li>
            <span className="font-semibold">Enablement and Adoption:</span> Building prompt libraries, adoption runbooks, and training programs that get non-technical teams trusting and using AI day-to-day.
          </li>
          <li>
